...
(function(root) {
define("JQuery.validate.message", ["JQuery.validate"], function() {
  return (function() {
/*
...
(function(root) {
define("JQuery.validate.extra", ["JQuery.validate"], function() {
  return (function() {
/*===================产品中目前用到的===================*/
/**
 * 手机号码验证
...
jQuery.validator.addMethod("PD_password", function(value, element) {
    return this.optional(element) || /(?=.*\d)(?=.*[a-zA-Z])(?=.*[^a-zA-Z0-9]).{8,30}$/.test(value);
}, "必须包含字母、数字、特称字符、8-30位");
...
define('jqValidate-build',["JQuery.validate","JQuery.validate.message","JQuery.validate.extra"],function () {
